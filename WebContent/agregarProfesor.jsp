...
<title>SGA - Agregar Profesor</title>
</head>
			...
			<div class="col-12 pb-5"></div>
				<div class="col-12 pt-5 pb-5 text-center">
					<font color="#cccccc">
						...
						<label style="margin-right: 80px">Clave:</label> <br> <input id="txtClave" name="txtClave" type="password" pattern="^\S{3,}$" onchange="this.setCustomValidity(this.validity.patternMismatch ? 'Debe tener 3 caracteres' : ''); if(this.checkValidity()) form.txtClaveV.pattern = this.value;" required> <br> <br> 
						<label style="margin-right: 15px">Confirme clave:</label> <br> 	<input id="txtClaveV" name="txtClaveV" type="password" pattern="^\S{3,}$" onchange="this.setCustomValidity(this.validity.patternMismatch ? 'Claves no coinciden' : '');" required> <br> <br> 
				...
				<div class="col-12 pt-5 text-center">
					...
					<%
						if (request.getAttribute("cantFilas") != null) 
						{
							...
							if(filas == 1) 
							{
								%><font color="#cccccc">Profesor registrado.</font><br><br><%
							}
							else
							{
								%><font color="#cccccc">No se pudo registrar el profesor.</font><br><br> <%
							}
						}
					%>
				</div>
